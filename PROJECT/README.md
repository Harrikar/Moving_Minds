...
Προτάσεις για τη χρήση zepelin για παρόμοιους σκοπούς έχουν γίνει, και κάποιες μάλιστα έχουν εφαρμοστεί. Το παρακάτω link οδηγεί σε ένα βίντεο το οποίο δείχνει τα σχέδια της εταιρίας Egon Airships για zepelins που θα χρησιμοποιηθούν για τουριστικούς σκοπούς: https://www.youtube.com/watch?v=yfXljWrKUW4. Αυτό οτ βίντεο μιλάει για την ιστορία, τους μηχανισμούς τον zepelins και πώς αυτά επανέρχονται σιγά σιγά για ταξίδια: https://www.youtube.com/watch?v=_phicOPoQT8.
## Core Values
